    ...
    <div class="m_top">
       ...
       <%--                     <li><a href="javascript:;" onclick="showleft('menu2_4','Pub/PubExcel.aspx')"><%=Resources.L.Excel导出 %></a></li>--%>
            ...
            <ul class="menu3">
                ...
                <li class="menu3_2"><a onclick="showleft('menu3_2','/AdminMVC/Product/StockList')"><%=Resources.L.库存管理 %></a></li>
            ...
            <ul class="menu8">
                ...
                <li class="menu8_3"><a onclick="showleft('menu8_3','Content/Node/NodeManage.aspx')"><%=Resources.L.节点管理 %></a></li>
                    ...
                    <ul class="m_left_ulin" id="menu8_3">
                        ...
                        <li id="menu8_3_5" class="input-group">
                            <div class="input-group margintop10">
                                ...
                                <span class="input-group-btn">
                                    <button id="NodeBtn" class="btn btn-default" type="button" onclick="ASCX.Search('Content/Node/NodeSearch.aspx?NodeID=','NodeSkey_t');"><span class="fa fa-search"></span></button>
                                </span>
                            </div>
                        </li>
                    </ul>
